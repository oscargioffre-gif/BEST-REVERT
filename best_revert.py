...
[data-testid="stExpander"] th { background: #000 !important; color: #64748b !important; padding: 8px 12px !important; font-size: 0.7rem !important; letter-spacing: 0.1em !important; text-transform: uppercase !important; border-bottom: 1px solid #0a1628 !important; }
...
.formula-box .f-label { font-size:0.62rem; color:#334155; letter-spacing:0.12em; text-transform:uppercase; margin-bottom:4px; }
.formula-box .f-val   { font-size:0.88rem; color:#38bdf8; font-weight:600; }
.formula-box .f-exp   { font-size:0.72rem; color:#64748b; margin-top:4px; }
.col-table { width:100%; border-collapse:collapse; font-family:'JetBrains Mono',monospace; font-size:0.78rem; margin:12px 0; }
.col-table th { background:#000; color:#334155; padding:7px 10px; text-align:left; font-size:0.62rem; letter-spacing:0.1em; text-transform:uppercase; border-bottom:1px solid #0a1628; }
...
<div style="margin-top:14px;font-size:0.68rem;color:#1e3a5f;border-top:1px solid #0a1628;padding-top:10px">
